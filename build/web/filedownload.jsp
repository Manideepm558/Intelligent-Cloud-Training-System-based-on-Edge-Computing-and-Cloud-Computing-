    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          ...
          <center>           <table border="1" cellspacing="1px" cellpadding="10px" width="800px">
                                <tr>
                               <th>S.NO</th>
                               <th>fileid</th>
                               <th>User Name</th>
...
String query = "select * from filerequest where username = ? and status = ?";
...
<tr>
    ...
    <td><a href="Download.jsp?fileid=<%=fileid%>&filename=<%=filename%>">Download</a></td>
</tr>
<%
                               }
}catch(Exception e){
